...
const Stats = () => {
  ...
  return (
    ...
    >
      ...
      >
        {/* {stat[1].attributes.figure} */}5+
        <br />{" "}
        <p className="font-poppins text-[#003865] text-lg font-extralight">
          {/* {stat[1].attributes.type} */}people
        </p>
      </motion.h1>
      <motion.h1
        initial={{ opacity: 0 }}
        ...
        className="font-poppins md:text-5xl text-3xl text-center text-[#00C2FF]"
      >
        {/* {stat[2].attributes.figure} */}5+
        <br />{" "}
        <p className="font-poppins text-[#003865] text-lg font-extralight">
          {/* {stat[2].attributes.type} */} people
        </p>
      </motion.h1>
      <motion.h1
        initial={{ opacity: 0 }}
        ...
        className="font-poppins md:text-5xl text-3xl text-center text-[#00C2FF]"
      >
        {/* {stat[3].attributes.figure} */}5+
        <br />{" "}
        <p className="font-poppins text-[#003865] text-lg font-extralight">
          {/* {stat[3].attributes.type} */}people
        </p>{" "}
      </motion.h1>
    </motion.div>
  );
